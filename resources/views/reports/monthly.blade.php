    ...
    <div class="container">
        ...
        <div class="filter-bar">
            ...
            <button onclick="window.print()" class="no-print"
                style="margin-left: auto; padding: 6px 12px; cursor: pointer;">🖨️ Imprimir</button>
        </div>

        <div style="text-align: center; margin-bottom: 20px;">
            <h2 style="margin:0; text-transform: uppercase;">FLUJO DE CAJA MENSUAL:
                {{ $startOfMonth->locale('es')->monthName }} {{ $startOfMonth->year }}</h2>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="{{ count($weeks) + 2 }}"
                        style="background:#eafaf1; text-align:center; font-size:10px; padding:2px;">INGRESOS</td>
                </tr>

                @php $monthTotalIngresos = 0;
                $weeklyIngresosSum = array_fill_keys(array_keys($weeks), 0); @endphp
            ...
            @php $monthTotalGastos = 0;
            $weeklyGastosSum = array_fill_keys(array_keys($weeks), 0); @endphp
