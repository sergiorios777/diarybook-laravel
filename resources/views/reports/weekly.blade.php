    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="9" style="background:#eafaf1; text-align:center; font-size:10px; padding:2px;">INGRESOS
                    </td>
                </tr>

                @php $weeklyTotalIngresos = 0;
                $dailyIngresosSum = array_fill_keys(array_keys($days), 0); @endphp
                ...
                <tr>
                    <td colspan="9" style="background:#fdedec; text-align:center; font-size:10px; padding:2px;">GASTOS</td>
                </tr>

                @php $weeklyTotalGastos = 0;
                $dailyGastosSum = array_fill_keys(array_keys($days), 0); @endphp
